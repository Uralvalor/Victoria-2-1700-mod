...
pops = {
	...
	PROMOTION_ASSIMILATION_CHANCE = 0.8,
	LUXURY_THRESHOLD = 500,
	BASE_GOODS_DEMAND = 0.8,
	BASE_POPGROWTH = 0.0003,
	MIN_LIFE_RATING_FOR_GROWTH = 24,
	LIFE_RATING_GROWTH_BONUS = 0.00007,
	...
	ARTISAN_MIN_PRODUCTIVITY = 0.95, -- Minimum efficieny of an artisan
