...
country = {
	...
	BASE_TARIFF_EFFICIENCY = 0.2, -- baseline tariff efficiency -- TODO
	...
	WRONG_REFORM_MILITANCY_IMPACT = 4,
	...
	TECH_YEAR_SPAN = 140,
	TECH_FACTOR_VASSAL = 0.3, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 100,
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 10, -- TODO base value that is powered by level of naval base. Determines the naval supplying capabilities. 
	...
	COLONIZATION_RELEASE_DOMINION_COST = 20,
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 270, -- multiplier to RP got by conquering as unciv when got enacted military reforms
...
economy = {
    ...
    RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.20,    -- how fast pops are Hired when there is a high demand
    ...
    TRADE_CAP_LOW_LIMIT_LAND = 0.02,                 -- the lowest % the slider can go for land units
...
pops = {
    ...
    CONVERSION_SCALE = 0.008,
    IMMIGRATION_SCALE = 0.005,

    PROMOTION_SCALE = 0.003,
    PROMOTION_ASSIMILATION_CHANCE = 0.02,
    ...
    ARTISAN_MIN_PRODUCTIVITY = 0.95, -- Minimum efficiency of an artisan
...
ai = {
    ...
    PEACE_TIME_MONTHS = 45, -- months of additional AI stubbornness in a war
